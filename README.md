```
 ____   __    ____  _____   __  ____  _____     ____  ____  ____  ____  ____
|  _ \ /__\  |  _ \|_   _| /__\|  _ \|_   _|   |  _ \/ ___||  _ \/ ___||  _ \
| |_) / /_\ \ | |_) | | | / /_\ \ |_) | | |===| | | \___ \| |_) \___ \| | | |
|  __/ / ___ \|  __/| | |/ /___ \|  _ < | |    | |_| |___) |  __/ ___) | |_| |
|_|  /_/   \_\_|  _|___/_/\_____/|_| \_\|_|    |____/|____/|_|   \____/|____/
                  |__|
```
...
```
    ...
    │      v              v                v           v         │
    │   ┌─────────────────────────────────────────────────────┐  │
    │   │           CLP(FD) CONSTRAINT STORE                  │  │
    │   │                                                     │  │
    │   │    Q in 0..Cap    Q in 0 \/ Moq..sup               │  │
    │   │    CostC = Q * UnitCost + Fixed * B                 │  │
    │   │    sum(Bs) >= MinSup                                 │  │
    │   │    100 * SupplierTotal <= Pct * TotalDemand          │  │
    │   └─────────────────────┬───────────────────────────────┘  │
    │                         │                                  │
    │                         v                                  │
    │                labeling([min(TCO)])                        │
...
```
                         +-------------+
                         |  facts.pl   |  <-- your data
                         |  or CSV     |      (demand, costs, constraints)
                         +------+------+
                                |
                                v
                    +-----------+-----------+
